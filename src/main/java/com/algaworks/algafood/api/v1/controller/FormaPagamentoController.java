...
//				.cacheControl(CacheControl.noStore())
	...
	@CheckSecurity.FormasPagamento.PodeEditar
	@PutMapping("/{formaId}")
	public FormaPagamentoModel atualizar(@PathVariable Long formaId,
			@RequestBody @Valid FormaPagamentoInput formaPagamentoInput) {
		FormaPagamento formaAtual = cadastroFormaPagamentoService.buscarOuFalhar(formaId);

		formaPagamentoInputDisassembler.copyToDomainObject(formaPagamentoInput, formaAtual);

		formaAtual = cadastroFormaPagamentoService.salvar(formaAtual);

		return formaPagamentoModelAssembler.toModel(formaAtual);
	}

	@CheckSecurity.FormasPagamento.PodeEditar
	@DeleteMapping("/{formaId}")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void remover(@PathVariable Long formaId) {
		cadastroFormaPagamentoService.excluir(formaId);
	}
